    ...
    *,
    ...
    if mode == "free_talk":
        frame = (
            ...
            "NEVER repeat yourself. Each message MUST bring up a NEW topic or question."
        )
        default_nudge = f"Continue the conversation — react to what was just said and bring up something NEW. Do not repeat yourself."
    elif mode == "debate":
        frame = (
            f'Debate topic: "{topic}". Stay on topic, push your angle, '
            "and answer the other side's last points. 2-3 short sentences. "
            "NEVER repeat what you said before. Each turn MUST introduce a NEW argument or perspective. "
            "If you find yourself repeating, stop and say something completely different."
        )
        default_nudge = f"Your turn, {self_name}. RESPOND to what was just said — say something NEW, do not repeat yourself."
    else:
        frame = f'Topic: "{topic}".'
